...
using GMap.NET.MapProviders.MGIS;
    ...
    public class GMapProviders
    {
      ...
      public static readonly OpenStreetMapSurferTerrainProvider OpenStreetMapSurferTerrain = OpenStreetMapSurferTerrainProvider.Instance;
        ...
        public static readonly AMapProvider AMap = AMapProvider.Instance;     //  add by allen
        public static readonly MgisMapProvider Mgis = MgisMapProvider.Instance;    // add by allen
