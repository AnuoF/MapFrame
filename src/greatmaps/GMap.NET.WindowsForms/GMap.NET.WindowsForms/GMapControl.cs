    ...
    public partial class GMapControl : UserControl, Interface
    {
      ...
      internal readonly Font MissingDataFont = new Font(FontFamily.GenericSansSerif, 8, FontStyle.Regular);
        ...
        public void UpdateRouteLocalPosition(GMapRoute route)
        {
            ...
            {
                //route.LocalPoints.Clear();     // by allen
...
#endif
                    //route.LocalPoints.Add(p);    // by allen
        ...
        /// #  DATE # -- Aug 31,2016
        /// </summary>
        /// <param name="route">线</param>
        /// <param name="pointArr">屏幕坐标数组</param>
        public Point[] UpdateRouteToArray(GMapRoute route)
        {
            ...
            {
                GPoint p = FromLatLngToLocal(route.Points[i]);
                p.OffsetNegative(Core.renderOffset);   // 设置偏移
      ...
      protected override void OnPaintBackground(PaintEventArgs e)
      {
        ...
        protected virtual void OnPaintOverlays(Graphics g)
        {
...
#endif
            {
                //g.DrawLine(ScalePen, -20, 0, 20, 0);     // modify by allen
                //g.DrawLine(ScalePen, 0, -20, 0, 20);     // Sep 5,2016
#if PocketPC
              g.DrawString("debug build", CopyrightFont, CopyrightBrush, 2, CopyrightFont.Size);
#else
                //g.DrawString("debug build", CopyrightFont, Brushes.Blue, 2, CopyrightFont.Height);   // modify by allen    Aug 31,2016
#endif
            }
#endif
            ...
            {
#if !PocketPC
                //g.DrawString(Core.provider.Copyright, CopyrightFont, Brushes.Navy, 3, Height - CopyrightFont.Height - 5);    // by allen 屏蔽掉Copyright
#else
      ...
      protected override void OnResize(EventArgs e)
      {
        ...
        /// <summary>
        /// 设置光标样式  2016年12月5日11:20:53  陈静添加
        /// </summary>
        ...
        {
            //base.OnMouseClick(e);       // 将此句放在方法体最后面，如果图元点击事件触发，则只触发图元点击事件，而不触发控件点击事件，防止同时触发事件
                        ...
                        foreach (GMapMarker m in o.Markers)
                        {
                            if (m.IsVisible && m.IsHitTestVisible)
                            {
                                ...
                                if (m.LocalArea.Contains((int)rp.X, (int)rp.Y))
                                {
                                    ...
                                    return;     //break;   // 如果多图元重合，则将会产生冒泡叠加的事件效果，所以暂时直接返回，后继最好加入图层顺序的调整
                                }
      ...
      public Size DragSize = new Size(4, 4);
        ...
        protected override void OnMouseWheel(MouseEventArgs e)
        {
            ...
            if (MouseWheelZoomEnabled && mouseIn && (!IsMouseOverMarker || IgnoreMarkerOnMouseWheel) && !Core.IsDragging)
            {
                ...
                //// set mouse position to map center     // modify by allen    Sep 6,2016
