...
namespace GMap.NET.WindowsForms.ToolTips
{
   ...
   public class GMapRoundedToolTip : GMapToolTip, ISerializable
   {
      ...
      public override void OnRender(Graphics g)
      {
         ...
         //g.DrawLine(Stroke, Marker.ToolTipPosition.X + Marker.Size.Width / 2, Marker.ToolTipPosition.Y + Marker.Size.Height / 2, rect.X + Radius / 2, rect.Y + rect.Height - Radius / 2);     // allen
